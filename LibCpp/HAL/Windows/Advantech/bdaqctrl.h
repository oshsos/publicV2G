...
{  
   DNL_Initialize(); 
   return DAQFN_GBL_TTT(DNLAPI_GBL, 22, ErrorCode, int32, int32)(edgeHandle, fusionNumber);
}
...
{
   DNL_Initialize();
   return DAQFN_GBL_TTT(DNLAPI_GBL, 23, ErrorCode, int32*, EthManagedEdge*)(count, edges);
}
...
BDAQINL ErrorCode         TDaqCtrlBase_getEthdaqEdge(DaqCtrlBase *obj, int32 size, wchar_t* srvName)                                               { return DAQFN_ETT(DNLAPI_BASE, 155, int32, wchar_t*)(obj, size, srvName); }
...
BDAQINL void              CntrFeatures_getSampleClkRateRange(CntrFeatures *obj, MathInterval *x)                                        {        DAQFN_VT(DNLAPI_CNTR, 265, MathInterval *)(obj, x);  }
...
public:
   ...
   void                       getSampleClkRateRange(MathInterval &x) {        CntrFeatures_getSampleClkRateRange(this, &x);                            }
