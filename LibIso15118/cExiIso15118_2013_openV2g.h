#ifndef CEXIISO15118_2013_OPENV2G_H
#define CEXIISO15118_2013_OPENV2G_H
...
class cExiIso15118_2013_openV2g : public cExiCodec
{
public:
    cExiIso15118_2013_openV2g();

    bool read_V2gHeaderTest(stV2gHeader& result, stStreamControl& stream);
    ...
    int  write_ExiDocument(struct iso1EXIDocument& exi, stStreamControl& stream);

protected:
    iso1EXIDocument receivedExiDocument;
